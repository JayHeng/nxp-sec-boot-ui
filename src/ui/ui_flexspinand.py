...
class secBootUiFlexspiNand(bootDeviceWin_FlexspiNand.bootDeviceWin_FlexspiNand):
    def __init__(self, parent):
        ...
        flexspiNandOpt, flexspiNandFcbOpt, flexspiNandKeyBlob = uivar.getVar(uidef.kBootDevice_FlexspiNand)
    ...
    def _getFrequence( self ):
        ...
        if txt == '30MHz':
            ...
            pass
        self.flexspiNandOpt = (self.flexspiNandOpt & 0xFFFFFFF8) | (val << 0)
    ...
    def _getPageSize( self ):
        ...
        if txt == '2KB':
            ...
            pass
        self.flexspiNandOpt = (self.flexspiNandOpt & 0xFFFFFCFF) | (val << 8)
    ...
    def _getBlockCountandID( self ):
        ...
        self.flexspiNandFcbOpt = (self.flexspiNandFcbOpt & 0xFFFFF0FF) | (val_block_id << 8)
    ...
    def apply_of_FLEXSPI_NAND(self, event):
        ...
        uivar.setVar(uidef.kBootDevice_FlexspiNand, self.flexspiNandOpt, self.flexspiNandFcbOpt, self.flexspiNandKeyBlob)
