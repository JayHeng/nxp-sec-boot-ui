    ...
    def RTxxx_updateOtpGroupText( self ):
        ...
        if self.mcuSeries == uidef.kMcuSeries_iMXRTxxx:
            if self.efuseGroupSel == 0:
                ...
                self.m_staticText_fuse420.SetLabel('0x008')
                self.m_staticText_fuse430.SetLabel('0x00c')
                self.m_staticText_fuse440.SetLabel('0x010')
                self.m_button_fuse450.SetLabel('014H')
                self.m_button_fuse460.SetLabel('018H')
                self.m_button_fuse470.SetLabel('01cH')
                self.m_staticText_fuse480.SetLabel('0x020')
                self.m_staticText_fuse490.SetLabel('0x024')
                self.m_staticText_fuse4a0.SetLabel('0x028')
                self.m_staticText_fuse4b0.SetLabel('0x02c')
                self.m_staticText_fuse4c0.SetLabel('0x030')
                self.m_staticText_fuse4d0.SetLabel('0x034')
                self.m_staticText_fuse4e0.SetLabel('0x038')
                self.m_staticText_fuse4f0.SetLabel('0x03c')
                self.m_staticText_fuse500.SetLabel('0x040')
                self.m_staticText_fuse510.SetLabel('0x044')
                self.m_staticText_fuse520.SetLabel('0x048')
                self.m_staticText_fuse530.SetLabel('0x04c')
                self.m_staticText_fuse540.SetLabel('0x050')
                self.m_staticText_fuse550.SetLabel('0x054')
                self.m_staticText_fuse560.SetLabel('0x058')
                self.m_staticText_fuse570.SetLabel('0x05c')
                self.m_staticText_fuse580.SetLabel('0x060')
                self.m_staticText_fuse590.SetLabel('0x064')
                self.m_staticText_fuse5a0.SetLabel('0x068')
                self.m_staticText_fuse5b0.SetLabel('0x06c')
                self.m_staticText_fuse5c0.SetLabel('0x070')
                self.m_staticText_fuse5d0.SetLabel('0x074')
                self.m_staticText_fuse5e0.SetLabel('0x078')
                self.m_staticText_fuse5f0.SetLabel('0x07c')
                self.m_staticText_fuse600.SetLabel('0x080')
                self.m_staticText_fuse610.SetLabel('0x084')
                self.m_staticText_fuse620.SetLabel('0x088')
                self.m_staticText_fuse630.SetLabel('0x08c')
                self.m_staticText_fuse640.SetLabel('0x090')
                self.m_staticText_fuse650.SetLabel('0x094')
                self.m_staticText_fuse660.SetLabel('0x098')
                self.m_staticText_fuse670.SetLabel('0x09c')
                self.m_staticText_fuse680.SetLabel('0x0a0')
                self.m_staticText_fuse690.SetLabel('0x0a4')
                self.m_staticText_fuse6a0.SetLabel('0x0a8')
                self.m_staticText_fuse6b0.SetLabel('0x0ac')
                self.m_staticText_fuse6c0.SetLabel('0x0b0')
                self.m_button_fuse6d0.SetLabel('0b4H')
                self.m_button_fuse6e0.SetLabel('0b8H')
                self.m_staticText_fuse6f0.SetLabel('0x0bc')
                self.m_staticText_fuse700.SetLabel('0x0c0')
                self.m_staticText_fuse710.SetLabel('0x0c4')
                self.m_staticText_fuse720.SetLabel('0x0c8')
                self.m_staticText_fuse730.SetLabel('0x0cc')
                self.m_staticText_fuse740.SetLabel('0x0d0')
                self.m_staticText_fuse750.SetLabel('0x0d4')
                self.m_staticText_fuse760.SetLabel('0x0d8')
                self.m_staticText_fuse770.SetLabel('0x0dc')
                self.m_staticText_fuse780.SetLabel('0x0e0')
                self.m_staticText_fuse790.SetLabel('0x0e4')
                self.m_staticText_fuse7a0.SetLabel('0x0e8')
                self.m_staticText_fuse7b0.SetLabel('0x0ec')
                self.m_staticText_fuse7c0.SetLabel('0x0f0')
                self.m_staticText_fuse7d0.SetLabel('0x0f4')
                self.m_staticText_fuse7e0.SetLabel('0x0f8')
                self.m_staticText_fuse7f0.SetLabel('0x0fc')
                self.m_staticText_fuse800.SetLabel('0x100')
                self.m_staticText_fuse810.SetLabel('0x104')
                self.m_staticText_fuse820.SetLabel('0x108')
                self.m_staticText_fuse830.SetLabel('0x10c')
                self.m_staticText_fuse840.SetLabel('0x110')
                self.m_staticText_fuse850.SetLabel('0x114')
                self.m_staticText_fuse860.SetLabel('0x118')
                self.m_staticText_fuse870.SetLabel('0x11c')
                self.m_staticText_fuse880.SetLabel('0x120')
                self.m_staticText_fuse890.SetLabel('0x124')
                self.m_staticText_fuse8a0.SetLabel('0x128')
                self.m_staticText_fuse8b0.SetLabel('0x12c')
                self.m_staticText_fuse8c0.SetLabel('0x130')
                self.m_staticText_fuse8d0.SetLabel('0x134')
                self.m_staticText_fuse8e0.SetLabel('0x138')
                self.m_staticText_fuse8f0.SetLabel('0x13c')
            elif self.efuseGroupSel == 1:
                self.m_button_fuse400.SetLabel('140H')
                self.m_staticText_fuse410.SetLabel('0x144')
                self.m_staticText_fuse420.SetLabel('0x148')
                self.m_staticText_fuse430.SetLabel('0x14c')
                self.m_staticText_fuse440.SetLabel('0x150')
                self.m_button_fuse450.SetLabel('154H')
                self.m_button_fuse460.SetLabel('158H')
                self.m_button_fuse470.SetLabel('15cH')
                self.m_staticText_fuse480.SetLabel('0x160')
                self.m_staticText_fuse490.SetLabel('0x164')
                self.m_staticText_fuse4a0.SetLabel('0x168')
                self.m_staticText_fuse4b0.SetLabel('0x16c')
                self.m_staticText_fuse4c0.SetLabel('0x170')
                self.m_staticText_fuse4d0.SetLabel('0x174')
                self.m_staticText_fuse4e0.SetLabel('0x178')
                self.m_staticText_fuse4f0.SetLabel('0x17c')
                ...
                self.m_staticText_fuse540.SetLabel('0x190')
                self.m_staticText_fuse550.SetLabel('SCfg5')
                self.m_staticText_fuse560.SetLabel('0x198')
                self.m_staticText_fuse570.SetLabel('SCfg7')
                self.m_staticText_fuse580.SetLabel('0x1a0')
                self.m_staticText_fuse590.SetLabel('UsbId')
                self.m_staticText_fuse5a0.SetLabel('0x1a8')
                self.m_staticText_fuse5b0.SetLabel('0x1ac')
                self.m_staticText_fuse5c0.SetLabel('0x1b0')
                self.m_staticText_fuse5d0.SetLabel('0x1b4')
                self.m_staticText_fuse5e0.SetLabel('0x1b8')
                self.m_staticText_fuse5f0.SetLabel('0x1bc')
                ...
                self.m_staticText_fuse500.SetLabel('RomP')
                self.m_staticText_fuse510.SetLabel('RomP')
                self.m_staticText_fuse520.SetLabel('RomP')
                self.m_staticText_fuse530.SetLabel('RomP')
                self.m_staticText_fuse540.SetLabel('RomP')
                self.m_staticText_fuse550.SetLabel('RomP')
                self.m_staticText_fuse560.SetLabel('RomP')
                self.m_staticText_fuse570.SetLabel('RomP')
                self.m_staticText_fuse580.SetLabel('RomP')
                self.m_staticText_fuse590.SetLabel('RomP')
                self.m_staticText_fuse5a0.SetLabel('RomP')
                self.m_staticText_fuse5b0.SetLabel('RomP')
                self.m_staticText_fuse5c0.SetLabel('RomP')
                self.m_staticText_fuse5d0.SetLabel('RomP')
                self.m_staticText_fuse5e0.SetLabel('RomP')
                self.m_staticText_fuse5f0.SetLabel('RomP')
                self.m_staticText_fuse600.SetLabel('RomP')
                self.m_staticText_fuse610.SetLabel('RomP')
                self.m_staticText_fuse620.SetLabel('RomP')
                self.m_staticText_fuse630.SetLabel('RomP')
                self.m_staticText_fuse640.SetLabel('RomP')
                self.m_staticText_fuse650.SetLabel('RomP')
                self.m_staticText_fuse660.SetLabel('RomP')
                self.m_staticText_fuse670.SetLabel('RomP')
                self.m_staticText_fuse680.SetLabel('RomP')
                self.m_staticText_fuse690.SetLabel('RomP')
                self.m_staticText_fuse6a0.SetLabel('RomP')
                self.m_staticText_fuse6b0.SetLabel('RomP')
                self.m_staticText_fuse6c0.SetLabel('RomP')
                self.m_button_fuse6d0.SetLabel('RomP')
                self.m_button_fuse6e0.SetLabel('RomP')
                self.m_staticText_fuse6f0.SetLabel('RomP')
                self.m_staticText_fuse700.SetLabel('RomP')
                self.m_staticText_fuse710.SetLabel('RomP')
                self.m_staticText_fuse720.SetLabel('RomP')
                self.m_staticText_fuse730.SetLabel('RomP')
                self.m_staticText_fuse740.SetLabel('RomP')
                self.m_staticText_fuse750.SetLabel('RomP')
                self.m_staticText_fuse760.SetLabel('RomP')
                self.m_staticText_fuse770.SetLabel('RomP')
                self.m_staticText_fuse780.SetLabel('RomP')
                self.m_staticText_fuse790.SetLabel('RomP')
                self.m_staticText_fuse7a0.SetLabel('RomP')
                self.m_staticText_fuse7b0.SetLabel('RomP')
                self.m_staticText_fuse7c0.SetLabel('RomP')
                self.m_staticText_fuse7d0.SetLabel('RomP')
                self.m_staticText_fuse7e0.SetLabel('RomP')
                self.m_staticText_fuse7f0.SetLabel('RomP')
                self.m_staticText_fuse800.SetLabel('RomP')
                self.m_staticText_fuse810.SetLabel('RomP')
                self.m_staticText_fuse820.SetLabel('RomP')
                self.m_staticText_fuse830.SetLabel('RomP')
                self.m_staticText_fuse840.SetLabel('RomP')
                self.m_staticText_fuse850.SetLabel('RomP')
                self.m_staticText_fuse860.SetLabel('RomP')
                self.m_staticText_fuse870.SetLabel('RomP')
                self.m_staticText_fuse880.SetLabel('RomP')
                self.m_staticText_fuse890.SetLabel('RomP')
                self.m_staticText_fuse8a0.SetLabel('RomP')
                self.m_staticText_fuse8b0.SetLabel('RomP')
                self.m_staticText_fuse8c0.SetLabel('RomP')
                self.m_staticText_fuse8d0.SetLabel('RomP')
                self.m_staticText_fuse8e0.SetLabel('RomP')
                self.m_staticText_fuse8f0.SetLabel('RomP')
                ...
                self.m_button_fuse400.SetLabel('N/A')
                self.m_staticText_fuse410.SetLabel('N/A')
                self.m_staticText_fuse420.SetLabel('N/A')
                self.m_staticText_fuse430.SetLabel('N/A')
                self.m_staticText_fuse440.SetLabel('N/A')
                self.m_button_fuse450.SetLabel('N/A')
                self.m_button_fuse460.SetLabel('N/A')
                self.m_button_fuse470.SetLabel('N/A')
                self.m_staticText_fuse480.SetLabel('N/A')
                self.m_staticText_fuse490.SetLabel('N/A')
                self.m_staticText_fuse4a0.SetLabel('N/A')
                self.m_staticText_fuse4b0.SetLabel('N/A')
                self.m_staticText_fuse4c0.SetLabel('N/A')
                self.m_staticText_fuse4d0.SetLabel('N/A')
                self.m_staticText_fuse4e0.SetLabel('N/A')
                self.m_staticText_fuse4f0.SetLabel('N/A')
                self.m_staticText_fuse500.SetLabel('N/A')
                self.m_staticText_fuse510.SetLabel('N/A')
                self.m_staticText_fuse520.SetLabel('N/A')
                self.m_staticText_fuse530.SetLabel('N/A')
                self.m_staticText_fuse540.SetLabel('N/A')
                self.m_staticText_fuse550.SetLabel('N/A')
                self.m_staticText_fuse560.SetLabel('N/A')
                self.m_staticText_fuse570.SetLabel('N/A')
                self.m_staticText_fuse580.SetLabel('N/A')
                self.m_staticText_fuse590.SetLabel('N/A')
                self.m_staticText_fuse5a0.SetLabel('N/A')
                self.m_staticText_fuse5b0.SetLabel('N/A')
                self.m_staticText_fuse5c0.SetLabel('N/A')
                self.m_staticText_fuse5d0.SetLabel('N/A')
                self.m_staticText_fuse5e0.SetLabel('N/A')
                self.m_staticText_fuse5f0.SetLabel('N/A')
